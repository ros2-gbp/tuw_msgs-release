...
%global pkg_name tuw_object_map_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-tuw-object-map-msgs
Version:        0.2.6
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Markus Bader <markus.bader@tuwien.ac.at> - 0.2.6-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Markus Bader <markus.bader@tuwien.ac.at> - 0.2.6-2
- Autogenerated by Bloom
