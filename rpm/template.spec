...
%global pkg_name tuw_multi_robot_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-tuw-multi-robot-msgs
Version:        0.2.6
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Benjamin Binder <benjamin.binder@tuwien.ac.at> - 0.2.6-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Benjamin Binder <benjamin.binder@tuwien.ac.at> - 0.2.6-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Benjamin Binder <benjamin.binder@tuwien.ac.at> - 0.2.6-1
- Autogenerated by Bloom
